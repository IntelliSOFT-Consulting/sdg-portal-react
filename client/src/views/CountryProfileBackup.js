...
function CountryProfile (props, ) {
    ...
    const parseMapData = (data) =>{
        ...
        setCountryProfileMapData(mapData);
    }
    ...
    useEffect(() => {
        ...
        if(cachedNormalizedData && cachedDemographicsData){
                ...
                fetchApiData().then(function(apiData){
                    if(apiData.length !== 0){
                        apiData.forEach(function(d){
                            if(d.page === "Country Profile" && d.section === 'Goal perfomance'){
                                countryProfileSdgsData = d
                                console.log(countryProfileSdgsData)
                            }else if(d.page === "Country Profile" && d.section === 'Demographics data'){
                                demographicsData = d
                        ...
                        <Col md="7" >
                            {
                                loading ? (
                                    ...
                                    <CountryProfileMap myCountryProfileData={countryProfileMapData} onCountryClick={handleSdgChildClick}></CountryProfileMap>
                                )
                            }
